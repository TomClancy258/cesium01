// src/views/aviation-situation/composables/cesium-events/event-handlers/shared/useDynamicSegmentDistanceLabel.ts
...
export const useDynamicSegmentDistanceLabel = (viewer: ShallowRef<Cesium.Viewer | null>, id:string) => {
  // 初始化临时坐标标签
