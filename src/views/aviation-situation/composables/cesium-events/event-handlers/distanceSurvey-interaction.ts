...
// 处理机场 hover
export const handleDistanceSurveyHover = (properties: AirportBillboardProperties, screenPosition: Cesium.Cartesian2, pickedObject: Cesium.PickedObject) => {
...
// 处理机场左键点击
export const handleDistanceSurveyLeftClick = (properties: AirportBillboardProperties, pickedObject: Cesium.PickedObject):void => {
