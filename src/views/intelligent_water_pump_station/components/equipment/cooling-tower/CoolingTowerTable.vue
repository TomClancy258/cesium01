...
import type { CoolingTowerRow } from '../../../types/station-equipment'
import { STATUS_LABEL, STATUS_TAG_TYPE } from '../../../types/station-equipment'

defineProps<{
  data: CoolingTowerRow[]
  total: number
  rowClassName: (ctx: { row: CoolingTowerRow }) => string
}>()
...
<template>
  <div>
    ...
    >
      ...
      <el-table-column prop="rpm" label="转速" sortable="custom" />
