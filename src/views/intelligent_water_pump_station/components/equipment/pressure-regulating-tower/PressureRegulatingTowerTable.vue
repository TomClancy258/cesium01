...
import type { PressureRegulatingTowerRow } from '../../../types/station-equipment'
import { STATUS_LABEL, STATUS_TAG_TYPE } from '../../../types/station-equipment'

defineProps<{
  data: PressureRegulatingTowerRow[]
  total: number
  rowClassName: (ctx: { row: PressureRegulatingTowerRow }) => string
}>()
...
<template>
  <div>
    ...
    >
      ...
      <el-table-column prop="level" label="液位" sortable="custom" />
