...
import type { VerticalPressurizedTankBodyRow } from '../../../types/station-equipment'
import { STATUS_LABEL, STATUS_TAG_TYPE } from '../../../types/station-equipment'

defineProps<{
  data: VerticalPressurizedTankBodyRow[]
  total: number
  rowClassName: (ctx: { row: VerticalPressurizedTankBodyRow }) => string
}>()
...
<template>
  <div>
    ...
    >
      ...
      <el-table-column prop="pressure" label="压力" sortable="custom" />
      <el-table-column prop="maxPressure" label="最高压力" />
      <el-table-column prop="temperature" label="温度" sortable="custom" />
