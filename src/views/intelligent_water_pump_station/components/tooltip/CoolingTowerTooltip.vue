...
import type { CoolingTowerRow, TooltipPosition } from '../../types/station-equipment'
...
const { row, visible, toTooltipStyle } = useEquipmentTooltip<CoolingTowerRow>('coolingTower')
