...
<template>
  <div>
    ...
    <div style="position: relative">
      <span class="my-float">地卫二空间技术</span
      >（杭州）有限公司是新一代太空智能公司，致力于成为全球领先的太空智能建设技术与服务提供商。公司是中国首家参与国家探月任务国际合作项目、首家完成向海外输出航天能力整体解决方案的民营商业航天企业。公司致力于以人工智能技术重构航天产业生态，以建设具备自主感知、决策、执行、协同能力的天地一体化智能系统为目标，以构建真实世界模型为技术路径，形成“感知—计算—规模化智能应用”的三阶太空智能能力体系，实现从太空改善地球。
    </div>
    ...
    <div class="test-rgba">
      父元素
      <div @click="console.log('aaaa')">子元素1</div>
    </div>

    <div style="background: yellow; margin-top: 10px">
      <div style="margin: 20px 0; background: #38bdf8; height: 100px; width: 100px">aaa</div>
    </div>

    <div class="css-triangle"></div>

    <div class="my-inline-block-container">
      <div>1</div>
      <div>2</div>
      <div>3</div>
      <div>4</div>
